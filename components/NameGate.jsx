  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-paper px-6">
      <form
        ...
        className="w-full max-w-sm rounded-xl border border-line bg-white p-8"
      >
        ...
        <input
          ...
          className="mt-5 w-full rounded-lg border border-line px-4 py-3 font-body text-sm text-ink placeholder:text-ink/35 focus:border-ledger"
        />
        <button
          type="submit"
